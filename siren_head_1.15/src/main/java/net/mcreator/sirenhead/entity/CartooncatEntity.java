...
public class CartooncatEntity extends SirenHeadModElements.ModElement {
	public static EntityType entity = null;
	public CartooncatEntity(SirenHeadModElements instance) {
		super(instance, 4);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -3407872, new Item.Properties().group(ItemGroup.MISC))
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new cartoon_cat(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("siren_head:textures/cartooncat.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("siren_head:cartoon_cat_song"));
		}
	...
	public class cartoon_cat extends EntityModel<Entity> {
		...
		public cartoon_cat() {
			...
			unknown_bone.setTextureOffset(8, 64).addBox(-1.0F, -48.0F, -3.0F, 2.0F, 3.0F, 2.0F, 1.0F, false);
			...
			left_leg.setTextureOffset(30, 59).addBox(-2.0152F, 0.0F, -2.1736F, 3.0F, 13.0F, 2.0F, 0.0F, false);
			left_leg2 = new ModelRenderer(this);
			left_leg2.setRotationPoint(-1.0152F, 14.0F, -0.1736F);
			left_leg.addChild(left_leg2);
			left_leg2.setTextureOffset(20, 49).addBox(-0.9848F, -2.0F, -1.8263F, 3.0F, 13.0F, 2.0F, 0.0F, false);
			left_leg2.setTextureOffset(58, 43).addBox(-1.3321F, 9.0F, -3.796F, 4.0F, 2.0F, 4.0F, 0.0F, false);
			right_leg = new ModelRenderer(this);
			right_leg.setRotationPoint(-3.0F, -1.0F, 0.0F);
			right_leg.setTextureOffset(10, 49).addBox(-0.9848F, 0.0F, -2.1736F, 3.0F, 13.0F, 2.0F, 0.0F, false);
			right_leg2 = new ModelRenderer(this);
			right_leg2.setRotationPoint(0.0152F, 14.0F, -0.1736F);
			right_leg.addChild(right_leg2);
			right_leg2.setTextureOffset(0, 49).addBox(-1.0152F, -2.0F, -1.8263F, 3.0F, 13.0F, 2.0F, 0.0F, false);
			right_leg2.setTextureOffset(24, 24).addBox(-1.6527F, 9.0F, -3.9696F, 4.0F, 2.0F, 4.0F, 0.0F, false);
			...
			right_ear.setTextureOffset(46, 30).addBox(-3.0F, -3.0F, -3.5F, 6.0F, 6.0F, 7.0F, 0.0F, false);
			right_ear.setTextureOffset(60, 16).addBox(-2.1014F, -6.2713F, -2.5F, 4.0F, 4.0F, 4.0F, 0.0F, false);
			right_ear.setTextureOffset(42, 30).addBox(-1.55F, -7.573F, -2.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			left_ear = new ModelRenderer(this);
			left_ear.setRotationPoint(3.0F, -42.6667F, -0.8333F);
			head.addChild(left_ear);
			setRotationAngle(left_ear, 0.0F, 0.0F, 0.1745F);
			left_ear.setTextureOffset(41, 17).addBox(-3.0F, -3.0F, -3.5F, 6.0F, 6.0F, 7.0F, 0.0F, false);
			left_ear.setTextureOffset(60, 0).addBox(-2.1014F, -6.2713F, -2.5F, 4.0F, 4.0F, 4.0F, 0.0F, false);
			left_ear.setTextureOffset(36, 8).addBox(-1.55F, -7.573F, -2.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
			...
			right_hand.setTextureOffset(48, 8).addBox(-2.0304F, -2.3473F, -2.0F, 8.0F, 4.0F, 4.0F, 0.0F, false);
			right_hand.setTextureOffset(0, 64).addBox(-2.0266F, 1.7399F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
			right_hand.setTextureOffset(62, 54).addBox(0.962F, 1.4784F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
			right_hand.setTextureOffset(62, 49).addBox(3.9506F, 1.2169F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
			...
			left_hand.setTextureOffset(36, 0).addBox(-1.4904F, -2.8473F, -2.0F, 8.0F, 4.0F, 4.0F, 0.0F, false);
			left_hand.setTextureOffset(62, 62).addBox(4.5096F, 0.7437F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			...
			this.left_leg2.rotateAngleX = MathHelper.cos(f * 0.6662F) * f1;
