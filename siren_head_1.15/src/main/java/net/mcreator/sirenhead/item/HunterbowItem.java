...
public class HunterbowItem extends SirenHeadModElements.ModElement {
	@ObjectHolder("siren_head:hunterbow")
	public static final Item block = null;
	@ObjectHolder("siren_head:entitybullethunterbow")
	public static final EntityType arrow = null;
	public HunterbowItem(SirenHeadModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullethunterbow").setRegistryName("entitybullethunterbow"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Preety useful as a long-ranged weapon."));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 15, 2);
