...
public class BonesworthEntity extends SirenHeadModModElements.ModElement {
	public static EntityType entity = null;
	public BonesworthEntity(SirenHeadModModElements instance) {
		super(instance, 8);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 2, 1, 4));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelskeleton(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("siren_head_mod:textures/skeleton.png.png");
					}
				};
			});
		}
