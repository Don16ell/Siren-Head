...
public class EntitySirenhead extends ElementsSirenHeadMod.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;
	public EntitySirenhead(ElementsSirenHeadMod instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("siren_head", "sirenhead"), ENTITYID).name("sirenhead").tracker(64, 3, true).egg(-4080283, -65536).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 15, 2, 4, EnumCreatureType.AMBIENT, spawnBiomes);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelnormal_siren_head(), 0.5f) {
	...
	public static class Modelnormal_siren_head extends ModelBase {
		...
		public Modelnormal_siren_head() {
			textureWidth = 64;
			textureHeight = 64;
			head = new ModelRenderer(this);
			head.setRotationPoint(0.0F, 0.0F, 0.0F);
			head.cubeList.add(new ModelBox(head, 32, 44, -2.0F, -43.0F, -2.0F, 4, 12, 4, -0.5F, false));
			r_siren = new ModelRenderer(this);
			r_siren.setRotationPoint(0.0F, 0.0F, 0.0F);
			head.addChild(r_siren);
			r_siren.cubeList.add(new ModelBox(r_siren, 32, 20, -7.0F, -41.0F, -3.0F, 6, 6, 6, -0.5F, false));
			l_siren = new ModelRenderer(this);
			l_siren.setRotationPoint(0.0F, 0.0F, 0.0F);
			head.addChild(l_siren);
			l_siren.cubeList.add(new ModelBox(l_siren, 32, 32, 1.0F, -41.0F, -3.0F, 6, 6, 6, -0.5F, false));
			body = new ModelRenderer(this);
			body.setRotationPoint(0.0F, -14.0F, 0.0F);
			body.cubeList.add(new ModelBox(body, 24, 0, -4.0F, -18.0F, -2.0F, 8, 16, 4, 0.0F, false));
			rightArm = new ModelRenderer(this);
			rightArm.setRotationPoint(-3.0F, -12.0F, 0.0F);
			rightArm.cubeList.add(new ModelBox(rightArm, 24, 24, -3.0F, -20.0F, -1.0F, 2, 36, 2, 0.0F, false));
			leftArm = new ModelRenderer(this);
			leftArm.setRotationPoint(5.0F, -12.0F, 0.0F);
			leftArm.cubeList.add(new ModelBox(leftArm, 16, 16, -1.0F, -20.0F, -1.0F, 2, 36, 2, 0.0F, false));
			rightLeg = new ModelRenderer(this);
			rightLeg.setRotationPoint(-2.0F, -2.0F, 0.0F);
			rightLeg.cubeList.add(new ModelBox(rightLeg, 8, 8, -1.0F, -14.0F, -1.0F, 2, 40, 2, 0.0F, false));
			leftLeg = new ModelRenderer(this);
			leftLeg.setRotationPoint(2.0F, -2.0F, 0.0F);
			leftLeg.cubeList.add(new ModelBox(leftLeg, 0, 0, -1.0F, -14.0F, -1.0F, 2, 40, 2, 0.0F, false));
		}
