...
public class ItemHunterbow extends ElementsSirenHeadMod.ModElement {
	@GameRegistry.ObjectHolder("siren_head:hunterbow")
	public static final Item block = null;
	public static final int ENTITYID = 13;
	public ItemHunterbow(ElementsSirenHeadMod instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("siren_head", "entitybullethunterbow"), ENTITYID).name("entitybullethunterbow").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("siren_head:hunterbow", "inventory"));
	}
