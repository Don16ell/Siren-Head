...
public class BonesworthEntity extends SirenHeadModElements.ModElement {
	public static EntityType entity = null;
	public BonesworthEntity(SirenHeadModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("bonesworth")
						.setRegistryName("bonesworth");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6710887, -10066330, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("bonesworth_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 4, 1, 4));
		}
	...
	public static class Modelskeleton extends EntityModel<Entity> {
		...
		public Modelskeleton() {
			...
			rightArm.setTextureOffset(40, 16).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 26.0F, 2.0F, 0.0F, false);
			...
			leftArm.setTextureOffset(40, 16).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 26.0F, 2.0F, 0.0F, true);
